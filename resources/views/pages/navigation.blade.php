...
<nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
    <div class="container">
        ...
        <h2 class="deskripsi-desa"
            style="font-size: 32px; font-weight: bold; color: #2c3e50; text-align: center; margin: 20px 0; font-family: 'Arial', sans-serif;">
            DESA KUMANTAN
        </h2>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ url('/#header')}}">HOME<span
                            class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ url('/#layanan')}}">LAYANAN E-SURAT</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="{{ url('/#features')}}">PROFILE</a>
                </li>
                <li class="nav-item">
