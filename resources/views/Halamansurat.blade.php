    ...
    <div class="container mt-4">
        <div class="row justify-content-center">
            ...
            {{-- <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100 border rounded-3 shadow-sm" style="background-color: #f8f9fa;">
                    <div class="card-body d-flex flex-column">
                        <h2 class="card-title text-dark">SURAT KETERANGAN BELUM MENIKAH</h2>
                        <h5 class="text-dark font-weight-bold mt-3">Persyaratan:</h5>
                        <ul class="text-muted">
                            <li>Surat Pengantar RT/RW</li>
                            <li>Fotokopi KK</li>
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('FormSurat.SuketBelumMenikah') }}" class="btn btn-primary btn-block">Buat
                                Surat</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100 border rounded-3 shadow-sm" style="background-color: #f8f9fa;">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            <a href="{{ route('User.keterangan_tidak_mampu') }}" class="btn btn-primary btn-block">Buat Surat</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {{-- <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100 border rounded-3 shadow-sm" style="background-color: #f8f9fa;">
                    <div class="card-body d-flex flex-column">
                        <h2 class="card-title text-dark">SURAT KETERANGAN DAN LAINNYA</h2>
                        <h5 class="text-dark font-weight-bold mt-3">Persyaratan:</h5>
                        <ul class="text-muted">
                            <li>Fotokopi KTP</li>
                            <li>Surat Pengantar RT/RW</li>
            ...
            {{-- <div class="col-lg-4 col-md-6 mb-4">
                <div class="card h-100 border rounded-3 shadow-sm" style="background-color: #f8f9fa;">
                    <div class="card-body d-flex flex-column">
                        <h2 class="card-title text-dark">SURAT PENGANTAR NIKAH ATAU PERKAWINAN</h2>
                        <h5 class="text-dark font-weight-bold mt-3">Persyaratan:</h5>
                        <ul class="text-muted">
                            <li>Fotokopi KTP</li>
                            <li>Surat Pengantar RT/RW</li>
